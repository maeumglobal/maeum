          ...
          <div className="flex items-start gap-4 flex-1">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                {t('Utilizamos cookies essenciais para o funcionamento do site e cookies analíticos para melhorar sua experiência.')}{' '}
                <a href={lp('/politica-de-privacidade')} className="text-primary hover:underline font-medium">
